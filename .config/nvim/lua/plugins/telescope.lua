return function()
  ...
  if vim.fn.executable 'make' == 1 then table.insert(telescope_plugins,
      'https://github.com/nvim-telescope/telescope-fzf-native.nvim') end
  ...
  vim.keymap.set('n', '<leader>sf',
    function() builtin.find_files({ preview = false }) end,
    { desc = '[S]earch [F]iles' }
  )
  ...
  vim.keymap.set('n', '<leader>s.',
    function() builtin.oldfiles({ preview = false }) end,
  ...
  vim.api.nvim_create_autocmd("FileType", {
    ...
    callback = function()
      vim.bo.autocomplete = false -- Use buffer-local option
    end,
  })
end
